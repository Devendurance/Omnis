...
export const pageContent = {
  tasks: {
    ...
    unavailable: "Task history is not connected in this preview.",
    action: "start a task",
  ...
  activity: {
    ...
    help: "When task execution is connected, service spending and settlement events will appear here.",
    unavailable: "The activity ledger is not connected in this preview.",
    action: "start a task",
  ...
  policies: {
    ...
    help: "Policies will belong to your tasks. No spending limits or permissions have been configured here.",
    unavailable: "Policy configuration is not connected in this preview.",
  ...
  approvals: {
    ...
    help: "When a task reaches its approval boundary, the exact action and its financial effect will appear here.",
    unavailable: "The approval queue is not connected in this preview.",
